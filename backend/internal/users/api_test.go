...
func GenerateBearerAccessToken(email entity.Email) string {
	tokens, _ := auth.GenerateTokens(email)
...
func TestApi(t *testing.T) {
	...
	tests := []test.ApiTestCase{
		...
		{Name: "create verify", Method: "GET", Url: "/users/2",
			Header:   http.Header{"Authorization": []string{GenerateBearerAccessToken("slava@example.com")}},
		...
		{Name: "get OK", Method: "GET", Url: "/users/1",
			Header:   http.Header{"Authorization": []string{GenerateBearerAccessToken("geogreck@example.com")}},
