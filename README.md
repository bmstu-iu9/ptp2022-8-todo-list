...
- [Технические составляющие проекта](#технические-составляющие-проекта)
  ...
  - [Запуск проекта с локальной сборкой контейнеров](#запуск-проекта-с-локальной-сборкой-контейнеров)
...
- [Документация по бэкенду](https://pkg.go.dev/github.com/bmstu-iu9/ptp2022-8-todo-list/backend)
